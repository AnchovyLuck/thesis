  ...
  return (
    <div className='my-6'>
      ...
      {cartItems.map((cartItem, i) => {
        return (
          <div key={i} className='flex items-center justify-between border-b border-slate-400 text-slate-600 dark:text-slate-100 font-bold text-sm py-3'>
      ...
      <div className='mt-4 flex justify-between items-center'>
        ...
        <button onClick={submitData} className='inline-flex items-center px-6 py-3 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-slate-900 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-slate-800 dark:bg-lime-600 dark:hover:bg-lime-700'>
