  ...
  return (
    ...
    >
      {products.map((product, i) => {
        return (
          <SwiperSlide className='flex flex-col rounded-lg border-0 bg-slate-100 dark:bg-slate-700' key={i}>
            <div className='bg-slate-100 dark:bg-slate-700  rounded-lg shadow-md'>
              ...
              <div className='flex items-center space-x-4 justify-center text-slate-600 dark:text-slate-200 w-full bg-slate-300 dark:bg-slate-800 rounded-b-lg py-2 px-4'>
                ...
                <button className='flex items-center justify-center gap-2 text-slate-200 bg-lime-600 hover:bg-lime-700 px-4 py-2 rounded-lg w-full'>
                  <BaggageClaim />
                  <span>Thêm</span>
                </button>
              </div>
